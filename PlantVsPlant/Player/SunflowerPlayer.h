...
public:
    SunflowerPlayer()
    {
        ...
        animation_attack_ex_left.set_animation_finish_callback([&]()
        {
            is_attacking_ex = false;
            is_sun_text_visible = false;
        });
        animation_attack_ex_right.set_animation_finish_callback([&]()
        {
            is_attacking_ex = false;
            is_sun_text_visible = false;
        });
    ...
    void on_attack() override
    {
        ...
        bullet->set_collision_callback([&]() { mp += 35; });
    ...
    void on_attack_ex() override
    {
        ...
        bullet->set_target(id == PlayerID::P1 ? PlayerID::P2 : PlayerID::P1);
        bullet->set_collision_callback([&]() { mp += 50; });
